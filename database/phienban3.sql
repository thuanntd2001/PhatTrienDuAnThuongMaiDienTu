...
-- Sun 12 Feb 2023 07:44:52 PM +07
...
CREATE TABLE IF NOT EXISTS `KINHDOANHIOT`.`NHANVIEN` (
  ...
  `NHANVIENTRANGTHAI` INT NOT NULL DEFAULT '0' COMMENT '1 hoat dong\\n0 ban\\n',
  PRIMARY KEY (`MANV`))
ENGINE = InnoDB
AUTO_INCREMENT = 25
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `KINHDOANHIOT`.`CHITIETDDH`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `KINHDOANHIOT`.`CHITIETDDH` ;

CREATE TABLE IF NOT EXISTS `KINHDOANHIOT`.`CHITIETDDH` (
...
-- -----------------------------------------------------
-- Table `KINHDOANHIOT`.`PHIEUXUAT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `KINHDOANHIOT`.`PHIEUXUAT` ;

CREATE TABLE IF NOT EXISTS `KINHDOANHIOT`.`PHIEUXUAT` (
...
-- -----------------------------------------------------
-- Table `KINHDOANHIOT`.`CTPX`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `KINHDOANHIOT`.`CTPX` ;

CREATE TABLE IF NOT EXISTS `KINHDOANHIOT`.`CTPX` (
  `MAPX` BIGINT NOT NULL,
  `SANPHAM` BIGINT NOT NULL,
  ...
  CONSTRAINT `fk_CTPX_PHIEUXUAT1`
    FOREIGN KEY (`MAPX`)
    REFERENCES `KINHDOANHIOT`.`PHIEUXUAT` (`MAPX`),
...
CREATE TABLE IF NOT EXISTS `KINHDOANHIOT`.`NHAN_SANPHAM` (
  ...
  CONSTRAINT `fk_NHAN_has_SANPHAM_NHAN1`
    FOREIGN KEY (`NHAN_ID`)
    REFERENCES `KINHDOANHIOT`.`NHAN` (`ID`),
...
CREATE TABLE IF NOT EXISTS `KINHDOANHIOT`.`TUKHOA_NHAN` (
  ...
  CONSTRAINT `fk_TUKHOA_has_NHAN_TUKHOA`
    ...
    REFERENCES `KINHDOANHIOT`.`TUKHOA` (`ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Data for table `KINHDOANHIOT`.`NHANVIEN`
-- -----------------------------------------------------
START TRANSACTION;
USE `KINHDOANHIOT`;
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (1, 'NHAN', '2003-03-21', 0, 1000000, '0121275555', '45460540654', '11 NGUYỄN ĐÌNH CHIỂU', '0011-07-13', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (2, 'NGUYỄN LUNG LINH', '2001-05-29', 1, 160000, '0308156570', '7084065406440', '244 Lê Văn Việt', '0013-06-07', 1);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (3, 'NGUYỄN TRẦN ĐỨC THUẬN', '0007-07-25', 1, 60000, '030815654 ', '7084065406440', '55 NGUYỄN VĂN THỦ', '0007-07-13', 1);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (4, 'ĐINH NHO NAM', '0025-07-07', 1, 60000, '03453454  ', '70840634440', '55 NGUYỄN VĂN THỦ', '0011-09-09', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (5, 'TRẦN VỚ VẨN', '1977-06-03', 1, 80000, '0308156543', '7084065240', '97 MAN THIỆN', '2022-01-01', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (6, 'HUỲNH NGỌC DƯƠNG', '2001-01-01', 1, 60000, '23415654  ', '7084065406440', '55 NGUYỄN VĂN THỦ', '2021-06-06', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (7, 'NGUYỄN Long Lanh', '2022-04-21', 0, 999999, '123123', '34', '33 ert', '2022-04-21', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (8, 'NGUYỄN LUNG LINh', '2022-04-21', 1, 123, '123', '34', '33 ert', '2022-04-21', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (9, 'NGUYỄN LUNG LINh', '2022-04-21', 1, 123, '123', '34', '33 ert', '2022-04-21', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (13, 'Mộng Mơ', '2022-05-01', 0, 123000, '0308156570', '13123123123', '244 LÊ VĂN VIỆT 2', '2022-05-05', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (16, 'Đức Thuận', '2001-02-11', 0, 123010, '0308152234', '7084065406443', '2323 nguyễn trường tộ', '2022-05-12', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (17, 'thuan', '2002-01-01', 1, 1230002, '0932323234', '3489787874654', '23 nguyện ty', '2022-05-06', 0);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (18, 'thuan 3', '2001-01-16', 1, 2342000, '3434343412', '70840654064', '33 ert', '2022-05-05', 1);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (19, 'NGUYỄN Lóng Lánh long lanh', '2002-02-21', 0, 1230000, '0308156570', '708406540', '2323 nguyễn trường tộ', '2022-05-04', 1);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (23, 'Bad girl', '1999-02-01', 1, 9000000, '0909232323', '12345678910', '123 nguyen tu q2', '2022-02-01', 1);
INSERT INTO `KINHDOANHIOT`.`NHANVIEN` (`MANV`, `HOTEN`, `NGAYSINH`, `GIOITINH`, `LUONG`, `SDT`, `CMND`, `DIACHI`, `NGAYVAOLAM`, `TRANGTHAI`) VALUES (24, 'good boy', '1999-02-01', 1, 9000000, '0909232323', '123456756410', '123 nguyen tu q2', '2022-02-01', 0);

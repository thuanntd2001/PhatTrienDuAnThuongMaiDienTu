...
<!-- Css Styles -->
<link rel="stylesheet" href="<c:url value='/template/khachhang/css/bootstrap.min.css'/>" type="text/css"/>
<link rel="stylesheet" href="<c:url value='/template/khachhang/css/font-awesome.min.css'/>" type="text/css"/>
<link rel="stylesheet" href="<c:url value='/template/khachhang/css/elegant-icons.css'/>" type="text/css"/>
<link rel="stylesheet" href="<c:url value='/template/khachhang/css/nice-select.css'/>" type="text/css"/>
